  ...
  return (
    <>
      <style>{`
        ...
        .notif-section-title { font-family:'Fredoka One',cursive;font-size:14px;color:${textMuted};margin-bottom:14px;text-transform:uppercase;letter-spacing:0.5px; }
        ...
        .notif-hour-btn { padding:9px 6px;border-radius:12px;border:2px solid ${border};background:transparent;
          font-family:'Fredoka One',cursive;font-size:13px;color:${textMuted};cursor:pointer;transition:all 0.18s;text-align:center; }
        ...
        <div className="notif-modal">
          <div className="notif-header">
            <div>
              ...
              <div style={{ fontSize:12, color:textMuted }}>Atur pengingat & alert game-mu</div>
            </div>
            <button onClick={onClose} style={{ background:'transparent',border:'none',fontSize:22,cursor:'pointer',color:textMuted,padding:8 }}>✕</button>
          </div>
            ...
            <div className="notif-section">
              ...
              <div className="notif-row">
                ...
                <div style={{ flex:1 }}>
                  ...
                  <div style={{ fontSize:12, color:textMuted, marginTop:1 }}>Ingatkan saat daily challenge tersedia</div>
                </div>
              ...
              {settings.dailyChallengeEnabled && (
                <>
                  <div style={{ marginTop:14, fontSize:12, color:textMuted, fontWeight:700, marginBottom:6 }}>Waktu Pengingat:</div>
            ...
            <div className="notif-section">
              ...
              <div className="notif-row">
                ...
                <div style={{ flex:1 }}>
                  ...
                  <div style={{ fontSize:12, color:textMuted, marginTop:1 }}>Notifikasi saat streak ≥ 3 hari · Streak sekarang: {dailyStreak || 0}</div>
                </div>
                <label className="notif-toggle">
