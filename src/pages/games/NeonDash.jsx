...
// ═════════════════════════════════════════════════════════════
const LVS=[
  // Lv1: Tutorial — flat, very generous spacing
  [['F',10],['DI'],['F',4],['S'],['F',5],['DI'],['F',4],['S'],['F',5],['S'],['F',5],['DI'],['F',6]],

  // Lv2: Intro blocks (small, easy to jump over)
  [['F',6],['DI'],['F',4],['S'],['F',5],['B',1,1],['F',5],['DI'],['F',3],['S'],['F',5],['U',1],['F',4],['DI'],['D',1],['F',5],['S'],['F',5]],

  // Lv3: Steps up and down — MORE SPACE before block!
  [['F',6],['S'],['F',4],['U',1],['F',3],['U',1],['DI'],['F',4],['S'],['F',3],['D',1],['F',3],['D',1],['F',4],['DI'],['F',3],['S'],['F',5],['B',1,2],['F',6],['U',2],['F',4],['D',2],['F',5]],

  // Lv4: Taller blocks + gaps — generous run-up
  [['F',5],['S'],['F',5],['B',1,2],['DI'],['F',5],['S'],['F',3],['S'],['F',5],['U',2],['F',4],['DI'],['D',2],['F',4],['G',2],['F',5],['S'],['F',5],['B',1,1],['F',5],['DI'],['F',4]],

  // Lv5: Wave intro — buffer before and after wave section
  [['F',5],['S'],['F',4],['U',1],['F',3],['DI'],['D',1],['F',3],['S'],['F',5],['P','wave'],['F',4],['W',0,80],['W',-20,75],['DI'],['W',20,75],['W',-10,75],['P','cube'],['F',5],['S'],['F',4],['B',1,1],['DI'],['F',5]],

  // Lv6: Staircase — clear spacing between each step+obstacle
  [['F',5],['S'],['F',4],['U',1],['F',3],['S'],['F',3],['U',1],['F',3],['DI'],['F',4],['D',1],['F',3],['S'],['F',3],['D',1],['F',4],['S'],['F',4],['S'],['F',4],['U',2],['F',3],['DI'],['F',3],['S'],['F',3],['D',2],['F',5],['B',2,2],['F',5],['DI'],['F',5]],

  // Lv7: Pillar + gap combo — pillar needs big run-up
  [['F',5],['S'],['F',3],['S'],['F',5],['PL',3],['DI'],['F',5],['G',2],['F',4],['S'],['F',4],['U',2],['F',4],['DI'],['D',2],['F',4],['PL',2],['F',5],['S'],['F',3],['S'],['F',4],['B',1,2],['DI'],['F',5]],

  // Lv8: Long wave section
  [['F',5],['S'],['F',4],['U',1],['DI'],['D',1],['F',4],['P','wave'],['F',4],['W',0,70],['W',-25,65],['W',30,65],['DI'],['W',-15,65],['W',25,60],['W',-30,60],['DI'],['P','cube'],['F',5],['S'],['F',3],['S'],['F',4],['U',1],['F',3],['D',1],['DI'],['F',5]],

  // Lv9: Mixed — still fair spacing
  [['F',4],['S'],['F',4],['B',1,2],['DI'],['F',5],['U',1],['F',3],['S'],['F',3],['U',1],['F',4],['DI'],['D',2],['F',3],['G',2],['F',4],['PL',3],['F',4],['S'],['F',3],['S'],['F',4],['P','wave'],['F',3],['W',0,60],['W',-30,58],['W',25,58],['DI'],['W',-20,55],['P','cube'],['F',4],['S'],['F',4]],

  // Lv10: Harder but still readable
  [['F',4],['S'],['F',3],['S'],['F',4],['U',1],['F',3],['S'],['F',3],['U',1],['DI'],['F',3],['D',1],['F',3],['D',1],['F',3],['S'],['F',4],['B',2,3],['F',5],['G',2],['F',4],['DI'],['U',2],['F',3],['S'],['F',3],['D',2],['F',4],['PL',4],['F',4],['S'],['F',3],['S'],['F',4],['DI'],['F',4],['P','wave'],['F',3],['W',0,58],['W',-35,55],['W',30,55],['W',-20,55],['DI'],['P','cube'],['F',4]],

  // Lv11: Getting intense
  [['F',3],['S'],['F',3],['S'],['F',3],['S'],['F',4],['U',2],['DI'],['F',3],['S'],['F',3],['D',1],['F',3],['D',1],['F',3],['B',1,3],['F',4],['G',2],['F',4],['U',1],['F',3],['S'],['F',3],['U',1],['F',3],['S'],['DI'],['D',2],['F',4],['PL',3],['F',3],['S'],['F',4],['P','wave'],['F',3],['W',0,55],['W',-30,55],['W',35,52],['DI'],['W',-25,52],['P','cube'],['F',3],['S'],['F',3],['S'],['F',4]],

  // Lv12: Tight but fair
  [['F',3],['S'],['F',3],['S'],['F',3],['U',1],['F',3],['S'],['F',3],['U',1],['F',3],['U',1],['DI'],['F',3],['D',1],['F',3],['S'],['F',3],['D',1],['F',3],['D',1],['F',3],['B',2,3],['F',5],['G',2],['F',4],['S'],['F',3],['U',2],['F',3],['DI'],['F',3],['S'],['F',3],['D',2],['F',3],['PL',4],['F',3],['S'],['F',3],['P','wave'],['F',3],['W',0,55],['W',-35,52],['W',30,52],['W',-20,50],['DI'],['W',25,50],['P','cube'],['F',3],['S'],['F',3],['S'],['F',3],['S'],['F',4]],

  // Lv13: Hard
  [['F',3],['S'],['F',3],['S'],['F',3],['S'],['F',3],['U',1],['F',3],['S'],['F',3],['U',1],['F',3],['S'],['F',3],['U',1],['DI'],['F',3],['D',1],['F',3],['D',1],['F',3],['S'],['F',3],['D',1],['F',3],['B',1,3],['F',5],['G',2],['F',4],['U',2],['F',3],['S'],['F',3],['S'],['DI'],['F',3],['D',2],['F',3],['PL',4],['F',4],['G',2],['F',4],['P','wave'],['F',3],['W',0,52],['W',-35,50],['W',30,50],['W',-25,50],['DI'],['W',35,50],['P','cube'],['F',3],['S'],['F',3],['S'],['F',3],['S'],['F',3],['S'],['F',4]],

  // Lv14: Extreme — every obstacle but still with F,3 minimum
  [['F',3],['S'],['F',3],['S'],['F',3],['S'],['F',3],['U',1],['F',3],['S'],['F',3],['U',1],['F',3],['S'],['F',3],['U',1],['F',3],['S'],['DI'],['F',3],['D',1],['F',3],['S'],['F',3],['D',1],['F',3],['S'],['F',3],['D',1],['F',3],['B',2,4],['F',5],['G',3],['F',4],['U',3],['F',3],['S'],['F',3],['S'],['DI'],['F',3],['D',3],['F',3],['PL',5],['F',4],['G',2],['F',4],['P','wave'],['F',3],['W',0,52],['W',-40,50],['W',35,50],['W',-30,50],['W',30,50],['DI'],['W',-35,50],['P','cube'],['F',3],['S'],['F',3],['S'],['F',3],['S'],['F',3],['S'],['F',3],['S'],['F',4]],
]
